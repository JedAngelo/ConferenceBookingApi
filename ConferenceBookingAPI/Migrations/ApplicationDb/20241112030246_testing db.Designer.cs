...
namespace ConferenceBookingAPI.Migrations.ApplicationDb
{
    ...
    [Migration("20241112030246_testing db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConferenceBookingAPI.Model.Status", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConferenceBookingAPI.Model.Booking", b =>
                {
                    ...
                    b.HasOne("ConferenceBookingAPI.Model.Status", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ConferenceBookingAPI.UserAuth.ApplicationUser", null)
                        .WithMany()
